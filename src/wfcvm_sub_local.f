c MHS TWEAK to turn fname from 2021/05/15/bas6.xyz to ./base6xyz
c WFCVM init
c--
...
c---loop to read-------------------
         do 117 i=1,numsur
c MHS          fname=rpath(1:loc1)//'/'//aedname(i)//asuf
...
c---file name assignment-----------
         fileib='boreholes3'
c MHS         fname=rpath(1:loc1)//'/'//fileib
         fname='./'//fileib
         kerr=0
         rmaxbh=0.
c---read file----------------------
...
c PES 2011/07/21
         ...
         kerr=0
c MHS         fname=rpath(1:loc1)//'/'//'reg_mod'
         fname='./reg_mod'
...
c -- here's input file name
         filesb='soil3.pgm'
c MHS         fname=rpath(1:loc1)//'/'//filesb
         fname='./'//filesb
         kerr=0
...
c MHS         fname=rpath(1:loc1)//'/'//fileig
         fname='./'//fileig
         kerr=0
c -- read file-----------------------------------------
